...
//							$value = CurrencyField::appendCurrencySymbol($currencyValue, $currencySymbol);
				...
				} elseif($field->getUIType() == 'FILEFLD'){
					$vtigerModuleModel = Vtiger_Module_Model::getInstance($module);
					$vtigerFieldModel = Vtiger_Field_Model::getInstance($fieldName, $vtigerModuleModel);
					$value = $vtigerFieldModel->getDisplayValue($value, $recordId);
				} else {
					$value = textlength_check($value);
				}
