	...
	<body>
		<div class="container-fluid login-container">
			<div class="row-fluid">
				...
				<div class="span3">
					<div class="helpLinks">
						<a href="http://www.novation.com.co">Novationsoft S.A.S</a> | 
						<a href="http://www.vtiger.com.co/">E-learning</a> 
					</div>
				</div>
			</div>
			<div class="row-fluid">
								...
								<div class="span8">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Novation CRM</h3>
		</div>
			...
			<div class="control-group">
				...
				<div class="controls">
											...
											<div class="login-subscript">
												<small> Desarrollado por vTiger Colombia 1.0</small>
											</div>
				</div>
										...
										<div class="login-box hide" id="forgotPasswordDiv">
											<form class="form-horizontal login-form" style="margin:0;" action="forgotPassword.php" method="POST">
												<div class="">
													<h3 class="login-header">Olvide la Contraseña</h3>
			</div>
			<div class="control-group">
